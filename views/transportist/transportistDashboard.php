...
<head>
    ...
    <title>Transportist Panel</title>
            ...
            <div class="col-auto col-md-2 sidebar bg-dark">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    <a class="d-flex align-items-center pb-3 mb-md-1 mt-md-3 me-md-auto text-white text-decoration-none">
                        <span class="fs-5 fw-bolder d-none d-sm-inline">Transportist Panel</span>
                        <span class="fs-5 d-sm-none">TP</span>
                    </a>
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start w-100" id="menu">
                        ...
                        <!-- Path Info -->
                        <li class="nav-item w-100">
                            <a href="?page=infoPath" data-page="infoPath" class="nav-link px-0 text-white">
                                <i class="fs-4 bi-truck"></i> <span class="ms-1 d-none d-sm-inline">Route Information</span>
                            </a>
                        </li>
                            ...
                            <div class="ms-auto d-flex align-items-center">
                                ...
                                <div class="dropdown">
                                    <button class="btn dropdown-toggle d-flex align-items-center" type="button" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <span class="me-2"><?php echo isset($_SESSION['username']) ? htmlspecialchars($_SESSION['username']) : 'Transportist'; ?></span>
                                    </button>
